...
export default function SignUpPage() {
  ...
  const handleMockGithubLogin = () => {
    // Navigate to repositories analyzer page as mock account creation success
    router.push("/repos");
  };
  ...
  return (
    <div className="flex-grow flex items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="absolute w-[400px] h-[400px] rounded-full bg-emerald-500/5 blur-[120px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
